...
/**
 * Tuple - это не изменяемый кортеж - это структура данных, которая хранит несколько значений разного типа
 * в одной переменной. Она часто используется в функциональном программировании. А так же
 * когда нужно вернуть несколько значений из метода, не создавая отдельный класс.
 * Это удобная альтернатива созданию DTO-классов для временных данных.
 * Обратите внимания, что для доступа к полям используется нотация с подчеркиванием, а не геттером, и
