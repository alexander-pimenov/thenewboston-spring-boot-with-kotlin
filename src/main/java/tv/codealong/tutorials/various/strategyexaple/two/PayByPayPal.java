package tv.codealong.tutorials.various.strategyexaple.two;
...
public class PayByPayPal implements PayStrategy {
    ...
    private boolean signedIn; //вошел в систему

    static {
        DATA_BASE.put("amanda1985", "amanda@ya.com");
        DATA_BASE.put("qwerty", "john@amazon.eu");
        DATA_BASE.put("qaz", "felix@mail.ru");
        DATA_BASE.put("qw123", "vf@ya.ru");
    }
