package tv.codealong.tutorials.various.fibonacci_and_factorial
 ...
 *
 * Рекомендации:
 * Для n ≤ 20 - используйте Long и итеративный подход
 *
 * Для n > 20 - используйте BigInteger версию
 *
 * Избегайте рекурсии - она менее эффективна и может привести к StackOverflowError
 *
